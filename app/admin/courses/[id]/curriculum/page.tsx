...
export default function AdminCurriculumPage() {
  ...
  const openSidebarContent = (type: ModalType) => {
    /* pick first module if any */
    setTargetMod(modules[0]?.id ?? '');
    setFTitle(''); setFDuration(''); setFPublished(true);
    if (type === 'uploadVideo')   setFType('tabler-video');
    if (type === 'uploadPdf')     setFType('tabler-file-text');
    if (type === 'addQuiz')       { setFType('tabler-file-analytics'); setQuizQuestions([]); setQuizPassScore(60); setQuizTimeLimit(30); }
    if (type === 'scheduleLive')  setFType('tabler-broadcast');
  ...
  return (
    <AdminLayout title="Edit Curriculum" breadcrumb="Home / Courses / Criminal Law Fundamentals / Curriculum">
      ...
      <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-6">
        <div className="d-flex align-items-center gap-3">
          <a href="/admin/courses/1" className="btn btn-icon btn-outline-secondary rounded-pill">
        ...
        <div className="d-flex flex-wrap gap-2">
          <a href="/admin/courses/1" className="btn btn-outline-secondary">
        ...
        <>
          <div className="offcanvas offcanvas-end show" style={{ visibility: 'visible', width: 440 }}>
            ...
            <div className="offcanvas-body">
              ...
              {/* Lesson type — only show on addLesson generic */}
