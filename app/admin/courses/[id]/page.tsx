    ...
    <AdminLayout title="Criminal Law Fundamentals" breadcrumb="Home / Courses / Criminal Law Fundamentals">
      <div className="row g-6">
        ...
        <div className="col-lg-8">
                  ...
                  <div className="d-flex flex-wrap row-gap-2 gap-8">
                    <div>
                      <p className="mb-2 text-nowrap">
                        <i className="ti tabler-users me-2"></i>Students: <strong>342</strong>
                      </p>
                      <p className="mb-2 text-nowrap">
                        <i className="ti tabler-circle-check me-2"></i>Avg. completion: <strong>68%</strong>
                      </p>
                      <p className="mb-2 text-nowrap">
                        <i className="ti tabler-notes me-2"></i>Avg. quiz score: <strong>74%</strong>
                      </p>
                      <p className="mb-0 text-nowrap">
                        <i className="ti tabler-star-filled me-2 text-warning"></i>Rating: <strong>4.8</strong> (124 reviews)
                      </p>
                    </div>
                    <div>
                      <p className="mb-2 text-nowrap">
                        <i className="ti tabler-video me-2"></i>Lessons: <strong>10</strong>
                      </p>
                      <p className="mb-2 text-nowrap">
                        <i className="ti tabler-clock me-2"></i>Duration: <strong>24 hours</strong>
                      </p>
                      <p className="mb-2 text-nowrap">
                        <i className="ti tabler-currency-rupee me-2"></i>Revenue: <strong>₹68,400</strong>
                      </p>
                      <p className="mb-0 text-nowrap">
                        <i className="ti tabler-check me-2"></i>Level: <strong>All Levels</strong>
                      </p>
                    </div>
                  </div>
          ...
          {/* ── Tabs: Students | Analytics | Settings ── */}
          <div className="card">
            <div className="card-header d-flex flex-wrap justify-content-between align-items-center gap-3">
              ...
              {tab === 'students' && (
                <a href="/admin/students" className="btn btn-sm btn-outline-primary">
              ...
              <div className="card-body">
                <div className="row g-4 mb-4">
                  {[
                    ...
                    { label: 'Revenue',    val: '₹68.4K', icon: 'tabler-currency-rupee', color: 'info' },
                  ].map(s => (
            ...
            {tab === 'settings' && (
              <div className="card-body">
                ...
                <div className="d-flex flex-wrap row-gap-2 gap-8 mb-2">
                  <div>
                    <p className="text-nowrap mb-2">
                      <i className="ti tabler-users me-2"></i>Students enrolled: <strong>342</strong>
                    </p>
                    <p className="text-nowrap mb-2">
                      <i className="ti tabler-circle-check me-2"></i>Avg. completion rate: <strong>68%</strong>
                    </p>
                  ...
                  <div>
                    <p className="text-nowrap mb-2">
                      <i className="ti tabler-star-filled me-2 text-warning"></i>Rating: <strong>4.8</strong> <span className="text-body-secondary fw-normal">(124 reviews)</span>
                    </p>
                    <p className="text-nowrap mb-2">
                      <i className="ti tabler-currency-rupee me-2"></i>Revenue earned: <strong>₹68,400</strong>
                    </p>
                    <p className="text-nowrap mb-0">
                      <i className="ti tabler-trending-up me-2 text-success"></i>Completion trend: <strong className="text-success">↑ 4% this month</strong>
                    </p>
                  </div>
                </div>
                ...
                <div className="row g-3">
                  {[
                    { icon: 'tabler-clipboard-list', label: 'Edit Curriculum',     sub: 'Manage lessons & modules', href: '/admin/courses/1/curriculum',  color: 'primary' },
                    { icon: 'tabler-video-plus',     label: 'Schedule Live Class',  sub: 'Set a new live session',   href: '/admin/live-classes/schedule', color: 'info'    },
                    { icon: 'tabler-users',          label: 'View Students',        sub: '342 students enrolled',    href: '/admin/students',              color: 'success' },
                    ...
                    <div key={a.label} className="col-sm-6">
                      <a
                        ...
                        style={{ borderRadius: 10, transition: 'border-color .15s' }}
                      >
                ...
                <div className="d-flex flex-wrap gap-3">
                  ...
                  <button className="btn btn-outline-warning">
                    <i className="ti tabler-eye-off me-1"></i>Unpublish
                  </button>
                  <button className="btn btn-outline-danger">
                    <i className="ti tabler-archive me-1"></i>Archive Course
                  </button>
                </div>
              </div>
            )}
        ...
        <div className="col-lg-4">
          {/* Curriculum Accordion — sticky, matches the template exactly */}
                  ...
                  <div className="accordion-collapse">
                    <div className="accordion-body py-4">
                      {mod.lessons.map((lesson, li) => (
                        <div
                          key={li}
                          className={`form-check${li < mod.lessons.length - 1 ? ' mb-4' : ''}`}
                        >
                          <input
